...
namespace SickscoreGames.HUDNavigationSystem
{
	public class HUDNavigationSystem_QSWindow : EditorWindow
	{
		...
		void OnGUI ()
		{
			...
			// CONTENT
			goPlayer = (GameObject)EditorGUILayout.ObjectField ("Playerx Controller", goPlayer, typeof(GameObject), true);
			goCamera = (Camera)EditorGUILayout.ObjectField ("Playerx Camera", goCamera, typeof(Camera), true);
