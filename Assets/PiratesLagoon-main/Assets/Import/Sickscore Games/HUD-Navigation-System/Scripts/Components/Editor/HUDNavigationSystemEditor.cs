...
public class HUDNavigationSystemEditor : HUDNavigationBaseEditor
{
	...
	protected override void OnBaseInspectorGUI ()
	{
		...
		EditorGUILayout.PropertyField (_pPlayerCamera, new GUIContent ("Playerx Camera"));
		EditorGUILayout.PropertyField (_pPlayerController, new GUIContent ("Playerx Transform"));
