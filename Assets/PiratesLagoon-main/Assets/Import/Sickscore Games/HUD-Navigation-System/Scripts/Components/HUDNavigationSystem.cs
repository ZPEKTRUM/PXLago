	...
	public class HUDNavigationSystem : MonoBehaviour
	{
		...
		public void EnableSystem (bool value)
		{
			...
			if (PlayerCamera == null) {
				...
				if (PlayerCamera == null)
					Debug.LogError("[HUDNavigationSystem] Playerx camera unassigned. Assign camera to resume system!");
			}
			if (PlayerController == null) {
				...
				if (PlayerController == null)
					Debug.LogError("[HUDNavigationSystem] Playerx transform unassigned. Assign transform to resume system!");
			}
