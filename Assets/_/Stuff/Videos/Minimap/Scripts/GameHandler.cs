...
public class GameHandler : MonoBehaviour {
    ...
    private void Start() {
        ...
        CMDebug.ButtonUI(new Vector2(300, 120), "Piratz Icon Show", playerMinimapIcon.Show);
        CMDebug.ButtonUI(new Vector2(300, 80), "Piratz Icon Hide", playerMinimapIcon.Hide);
